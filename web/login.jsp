...
<%--    <link rel="stylesheet" href="${pageContext.request.contextPath}/bootstrap/css/bootstrap.css">--%>
    <link href="${pageContext.request.contextPath}/登录界面_files/default.css" rel="stylesheet" type="text/css">
    <!--必要样式-->
    <link href="${pageContext.request.contextPath}/登录界面_files/styles.css" rel="stylesheet" type="text/css">
    <link href="${pageContext.request.contextPath}/登录界面_files/demo.css" rel="stylesheet" type="text/css">
    <link href="${pageContext.request.contextPath}/登录界面_files/loaders.css" rel="stylesheet" type="text/css">
</head>
    ...
    <form action="${pageContext.request.contextPath}/user/login" method="post">
        <div class="login_fields">
            <div class="login_fields__user">
                <div class="icon">
                    <img alt="" src="${pageContext.request.contextPath}/登录界面_files/user_icon_copy.png">
                </div>
                <input name="account" placeholder="用户名" maxlength="16" type="text" autocomplete="off">
                <div class="validation">
                    <img alt="" src="${pageContext.request.contextPath}/登录界面_files/tick.png">
                </div>
            </div>
            <div class="login_fields__password">
                <div class="icon">
                    <img alt="" src="${pageContext.request.contextPath}/登录界面_files/lock_icon_copy.png">
                </div>
...
<link href="${pageContext.request.contextPath}/登录界面_files/layui.css" rel="stylesheet" type="text/css">

<script type="text/javascript" src="${pageContext.request.contextPath}/登录界面_files/jquery.min.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/登录界面_files/jquery-ui.min.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/登录界面_files/stopExecutionOnTimeout.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/登录界面_files/layui.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/登录界面_files/Particleground.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/登录界面_files/Treatment.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/登录界面_files/jquery.mockjax.js.下载"></script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/登录界面_files/ThreeWebGL.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/登录界面_files/ThreeExtras.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/登录界面_files/Detector.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/登录界面_files/RequestAnimationFrame.js.下载"></script>
